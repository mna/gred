...
func TestCommand(t *testing.T) {
	cases := []struct {
		...
		{"rpush", []string{"l2", "a", "b"}, int64(2), nil},
		{"rpush", []string{"l3", "c", "d", "e"}, int64(3), nil},
		{"blpop", []string{"l1", "l2", "l3", "1"}, []string{"l2", "a"}, nil},
		{"blpop", []string{"l1", "l2", "l3", "1"}, []string{"l2", "b"}, nil},
		{"blpop", []string{"l1", "l2", "l3", "1"}, []string{"l3", "c"}, nil},
		{"rpush", []string{"l2", "a", "b"}, int64(2), nil},
		{"brpop", []string{"l1", "l2", "l3", "1"}, []string{"l2", "b"}, nil},
		{"brpop", []string{"l1", "l2", "l3", "1"}, []string{"l2", "a"}, nil},
		{"brpop", []string{"l1", "l2", "l3", "1"}, []string{"l3", "e"}, nil},
		{"brpoplpush", []string{"l3", "l2", "1"}, "d", nil},
		{"llen", []string{"l3"}, int64(0), nil},
		{"lrange", []string{"l2", "0", "-1"}, []string{"d"}, nil},
		{"blpop", []string{"t", "l2", "l3", "1"}, nil, cmd.ErrInvalidValType},
		{"brpop", []string{"t", "l2", "l3", "1"}, nil, cmd.ErrInvalidValType},
		{"brpoplpush", []string{"h", "l2", "1"}, nil, cmd.ErrInvalidValType},
